<template>
  <div class="h-screen w-screen flex flex-col overflow-hidden bg-[#0F1115] text-[#FFFFFF] select-none font-sans">
    <!-- Top Custom Glass Title Bar -->
    <TitleBar />

    <!-- Application Body (macOS Glass Sidebar + Main Canvas) -->
    <div class="flex-1 flex min-h-0 overflow-hidden relative">
      ...
      <aside class="w-64 bg-[#171A21]/80 backdrop-blur-[30px] border-r border-white/[0.08] flex flex-col justify-between p-3.5 shrink-0 z-30 shadow-[0_12px_40px_rgba(0,0,0,0.25)]">
        ...
        <nav class="space-y-1 flex-1 overflow-y-auto">
          <!-- Section Label -->
          <div class="px-3 pt-2 pb-1.5 text-[11px] font-medium tracking-wider uppercase text-[#7D8592]">
            Menu
          </div>
        ...
        <!-- Bottom User Profile & Branding Strip -->
        <div class="pt-3 border-t border-white/[0.08] space-y-2">
          ...
          <div class="flex items-center justify-between px-2 pt-1">
            <span class="text-[11px] text-[#7D8592] font-medium">Apple App Store Suite</span>
            <span class="text-[10px] text-[#7D8592] font-mono">IPA Downloader</span>
          </div>
        </div>
      </aside>
