      ...
      <div v-if="filteredFavorites.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-6">
        ...
        >
          ...
          <div class="flex items-start space-x-3.5">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center justify-between">
                ...
                <button
                  type="button"
                  class="text-[#FF453A] hover:opacity-80 transition-all duration-300 ease-liquid active:scale-90"
          ...
          <div class="flex items-center justify-end space-x-2 pt-3 border-t border-white/[0.08]">
            <button
              type="button"
              class="btn-primary liquid-shine text-xs px-4 py-1.5 flex items-center space-x-1.5 w-full"
